...
public:
	...
	BOOL Load(LPCTSTR szFileName,BOOL bAdaptToClient=FALSE,RECT ClientRect=RECT());
	...
	BOOL Load(LPCTSTR szResourceName,LPCTSTR szResourceType,BOOL bAdaptToClient=FALSE,RECT ClientRect=RECT());

	void SetAdStyle(bool bAdStyle);

protected:

	bool	m_bAdStyle;	// ÊÇ·ñÊÇAD¿Ø¼þ
